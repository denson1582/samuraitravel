...
public class AuthController {
			             ...
			             Model model) 
	{
		...
		User createdUesr = userService.createUser(signupForm);
		String requstUrl = new String(httpServletRequest.getRequestURL());
		signupEventPublisher.publishSignupEvent(createdUesr, requstUrl);
